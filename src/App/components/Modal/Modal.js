...
const Modal = (props) => {
  ...
  return modal.isOpen ? (
    <div className={styles.Modal} style={{ backgroundColor:'grey', position: 'absolute', top: 0, bottom: 0, left: 0, right: 0 }} data-testid="Modal">
      <div style={{ backgroundColor:'white', position: 'absolute', top: '50vh', bottom: '50vh', left: '50vw', right: '50vw' }}>
        {modal.children}
        <br />
